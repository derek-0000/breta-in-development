...
export default function LoginSigninForm() {
  ...
  return (
    <>
      {hiddenStatus == false && (
        <aside className="absolute rounded-t-2xl h-3/4 bottom-0 flex flex-col bg-white  w-full md:h-full md:relative md:w-1/3 z-10 md:rounded-l-2xl">
          <div className="relative flex flex-col justify-center items-center p-4 h-full w-full md:p-4 lg:p-12">
            <button
